...
<article class="home_featured">
    ...
    <div class="home_featured_app">
        <img src="site/images/home-app.jpg" alt="CafeControl" title="CafeControl"/>
    </div>
</article>
...
<div class="home_features">
    <section class="container content">
        ...
        <div class="home_features_content">
            ...
            <article class="radius">
                <header>
                    <img alt="Contas a pagar" title="Contas a pagar" src="site/images/home_pay.jpg"/>
    ...
    <div class="blog_content container content">
        ...
        <div class="blog_articles">
            <article class="blog_article">
                <a title="Post" href="?file=post"><img title="Blog" alt="Blog" src="site/images/home-featured.jpg"/></a>
                <header>
                    <p class="meta">Blog &bull; Por Robson V. Leite &bull; 22/12/18 23h23</p>
                    <h2><a title="Post" href="?file=post">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</a></h2>
                    <p><a title="Post" href="?file=post">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad amet autem
