...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>SIS-PDCD | SISTEMA DE INFORMAÇÃO DE SAÚDE</title>
                    ...
                    <div class="col-lg-5 col-xl-5">
                        <div class="banner_text">
                            <div class="banner_text_iner">
                                ...
                                <p>Aqui na SIS-PDC você encontra os melhores médicos da região,
                                ...
                                <div class="col-xl-8">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-4">
                                            <img class="img-shape" src="{{ asset('img/pictures/1.png') }}" alt="doctor">
                                            <h3>Dra. Adriana Galvão</h3>
                                            <p>Cardiologista</p>
                                        </div>
                                        <div class="col-lg-4 col-sm-4">
                                            <img class="img-shape" src="{{ asset('img/pictures/2.png') }}" alt="doctor">
