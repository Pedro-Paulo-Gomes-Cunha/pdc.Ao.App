...
<div>
            ...
            <div class="page-header">
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Utentes</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#utente">Adicionar</button>
                </div>
                <div class="card-body">
    ...
    @include('admin.modals.utente-modal')
</div>
