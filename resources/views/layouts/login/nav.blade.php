...
<header class="main_header gradient gradient-green">
  <div class="container">
      <div class="main_header_logo">
          <h1><a class="icon-heartbeat transition" title="Home" href="./">Cafe<b>Control</b></a></h1>
      </div>
      ...
      <nav class="main_header_nav">
          ...
          <div class="main_header_nav_links j_menu_mobile_tab">
              ...
              <a class="link transition radius" title="Sobre" href="#">Sobre</a>
              <a class="link transition radius" title="Blog" href="#">Blog</a>
              <a class="link login transition radius icon-sign-in" title="Entrar" href="#">Entrar</a>
          </div>
      </nav>
  </div>
</header>
